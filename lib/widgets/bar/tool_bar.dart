        ...
        child: FloatingActionButton.small(
          ...
          onPressed: () async {
            ...
            if (selectedDirectory != null) {
              ref
                  .read(projectDirectoryPathProvider.notifier)
                  .changeDirectoryPath(selectedDirectory);
            }
          },
          child: const Icon(Icons.add),
        ),
      ),
      trailing: ResponsiveBreakpoints.of(context).screenHeight > 400
          ? Expanded(
              child: Align(
          ...
          : null,
      destinations: ResponsiveBreakpoints.of(context).screenHeight > 400
          ? <NavigationRailDestination>[
              NavigationRailDestination(
                ...
                selectedIcon: FaIcon(FontAwesomeIcons.fileCode,
                    size: coreToolBarIconSize),
              ...
              NavigationRailDestination(
                ...
                icon: FaIcon(FontAwesomeIcons.codeBranch,
                    size: coreToolBarIconSize,
                    color: Theme.of(context).iconTheme.color!.withOpacity(0.5)),
                selectedIcon: FaIcon(FontAwesomeIcons.codeBranch,
                    size: coreToolBarIconSize),
