...
final coreToolBarStateProvider =
    AutoDisposeNotifierProvider<CoreToolBarState, int?>.internal(
  CoreToolBarState.new,
  name: r'coreToolBarStateProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$coreToolBarStateHash,
  dependencies: null,
